<template>
  <div class="item-sub">
    <div class="sub-left">
      <p class="sub-links"><span class="sub-title">链接：</span><a :href="item.officalSite" target="_blank">官方网站</a><a :href="bangumiURL" target="_blank">Bangumi页面</a></p>
      <p class="sub-links"><span class="sub-title">下载：</span>
    ...
    <div class="sub-middle">
      <p><span class="sub-title">放送日期：</span><span>{{item.showDate}}</span></p>
      <p></p>
    </div>
    <div class="sub-right">
      <p>
